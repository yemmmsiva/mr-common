...
public interface OrganizationService {
	 ...
	 * @see #find(String, Serializable, Role, Boolean, ConfigurableData)
	 */
	 ...
	 * @see #findCount(String, Serializable, Role, Boolean)
	 */
	int count();
	...
	/**
	 * @param id identificador único de la organización.
